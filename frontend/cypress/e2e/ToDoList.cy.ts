describe('ToDo List', () => {
  ...
  it('Should filter tasks based on priority', () => {
    ...
    cy.get('.mantine-SimpleGrid-root').within(() => {
      cy.contains('Task 1 - priority 1').should('exist');
    });
    ...
    cy.get('.mantine-SimpleGrid-root').within(() => {
      cy.contains('Task 2 - priority 2').should('exist');
    });
    ...
    cy.get('.mantine-SimpleGrid-root').within(() => {
      cy.contains('Task 3 - priority 3').should('exist');
    });
  });
  ...
  it('Should reset priority filter when reset button is clicked', () => {
    ...
    cy.get('.mantine-SimpleGrid-root').within(() => {
      cy.contains('Task 1 - priority 1').should('not.exist');
    });
    cy.get('.mantine-SimpleGrid-root').within(() => {
      cy.contains('Task 2 - priority 2').should('not.exist');
    });
    cy.get('.mantine-SimpleGrid-root').within(() => {
      cy.contains('Task 3 - priority 3').should('exist');
    });
